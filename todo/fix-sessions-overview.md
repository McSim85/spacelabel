...
| ✅ [remove-pipx.md](remove-pipx.md) | — *(done 2026-06-25)* | medium · Sonnet 4.6 | `install.py` tests docs |
| ✅ [fix-brew-upgrade-race.md](fix-brew-upgrade-race.md) | **AB** *(done 2026-06-25; Fix A only, Fix B rejected)* | low · Sonnet 4.6 | `app.py` `Casks/spacelabel.rb` |
